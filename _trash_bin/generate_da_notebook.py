 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    )\n",
    "    \n",
    "    # We compile with a tiny learning rate to delicately adjust weights without forgetting DEFACTO\n",
    "    model.compile(\n",
    ...
    "]\n",
    "\n",
    "print(\"Starting Domain Adaptation on CASIA v2...\")\n",
    "history = model.fit(\n",
    "    train_ds,\n",
...
with open("LMS_FNet_CASIA_Domain_Adaptation.ipynb", "w", encoding='utf-8') as f:
